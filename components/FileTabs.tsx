  ...
  return (
    <Tabs
      ...
      classNames={{
        ...
        tabList: "gap-2 sm:gap-4 md:gap-6 flex-nowrap min-w-full border-b border-white/10",
        tab: "py-3 whitespace-nowrap text-slate-400 data-[selected=true]:text-indigo-400",
